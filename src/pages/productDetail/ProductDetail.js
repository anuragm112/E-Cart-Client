...
function ProductDetail() {
  ...
  async function fetchData(){
      const productResponse=await axiosClient.get(`/products?filters[key][$eq]=${params.productId}&populate=*`);      if(productResponse.data.data.length > 0){
      ...
      <div className="container">
        <div className="product-layout">
          ...
          <div className="product-info">
            ...
            cancellations and returns. Read our Return Policy.
               </li>
              </ul>
            </div>
          </div>
